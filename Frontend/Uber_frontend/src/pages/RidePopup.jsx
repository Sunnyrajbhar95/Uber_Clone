...
function RidePopup({ setPopup,setConfimRidepannel }) {
  return (
    <div className="w-full  flex flex-col items-center p-2 ">
      ...
      <div className="w-full mt-4">
        <h4 className="text-2xl font-semibold ">New Ride Available!</h4>
      </div>
      ...
      <button className="w-full bg-green-500 mt-2 text-xl py-2 rounded-lg" onClick={()=>{
           setConfimRidepannel(true)
           setPopup(false);
      }}>
        Accept
      </button>
      <button
        className="w-full bg-gray-500 mt-2 text-xl py-2 rounded-lg"
        onClick={() => {
          setPopup(false);
        }}
      >
